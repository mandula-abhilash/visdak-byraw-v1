...
export const HomeLoanWidget = ({
  ...
  const handleCalculate = () => {
    const { maxLoanAmount, monthlyEMI, totalInterest } =
    ...
    setResult({
      ...
      monthlyEMI,
      totalInterest,
      emiToIncomeRatio: (monthlyEMI / parseFloat(values.monthlyIncome)) * 100,
    });
  };
          ...
          {result && (
            <div className="space-y-4 p-4 bg-accent/50 rounded-lg">
              <div className="space-y-2">
                ...
                <Progress value={result.emiToIncomeRatio} className="h-2" />
              </div>
